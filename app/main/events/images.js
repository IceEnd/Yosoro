...
export default class Common extends Event {
  ...
  setListener() {
    ...
    listener('pic-upload', async (event, paylod) => {
      try {
    ...
    listener('pic-upload-sync', async (event, paylod) => {
